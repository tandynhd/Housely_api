...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 08, 2021 at 07:34 AM
...
INSERT INTO `room` (`roomID`, `roomPrice`) VALUES
(1101, '4500.00'),
(1102, '5400.00'),
(1103, '5500.00'),
(1104, '6500.00');
...
INSERT INTO `roomcontract` (`rContID`, `staffID`, `custID`, `roomID`, `contSDate`, `contEDate`) VALUES
(1, 4, 1, 1101, '2020-11-14', '2021-11-14'),
(2, 4, 2, 1104, '2020-12-25', '2021-12-25');
...
CREATE TABLE `service` (
  ...
  `servthumbnail` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `service` (`servID`, `staffID`, `custID`, `servCataID`, `servDesc`, `servthumbnail`) VALUES
(1, 1, 1, 1, 'Dywall Repair', 'ee'),
(2, 3, 2, 2, 'Room cleaning', 'e');
...
INSERT INTO `servicecatagory` (`servCataID`, `servCataName`, `servPrice`) VALUES
(1, 'Mechanical Service', '0.00'),
(2, 'Cleaning Service', '500.00'),
(3, 'Moving Service', '1500.00'),
(4, 'Delivery Service', '400.00');
...
--
ALTER TABLE `roomcontract`
  ADD CONSTRAINT `fk_4` FOREIGN KEY (`custID`) REFERENCES `customer` (`custID`),
  ADD CONSTRAINT `fk_5` FOREIGN KEY (`roomID`) REFERENCES `room` (`roomID`),
  ADD CONSTRAINT `fk_6` FOREIGN KEY (`staffID`) REFERENCES `staff` (`StaffID`);

--
-- Constraints for table `service`
--
ALTER TABLE `service`
  ADD CONSTRAINT `fk_7` FOREIGN KEY (`custID`) REFERENCES `customer` (`custID`),
  ADD CONSTRAINT `fk_8` FOREIGN KEY (`servCataID`) REFERENCES `servicecatagory` (`servCataID`),
